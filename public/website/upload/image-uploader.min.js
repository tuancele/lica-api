...
(function ($) {
    $.fn.imageUploader = function (options) {
        let defaults = { preloaded: [], imagesInputName: "images", preloadedInputName: "preloaded", label: "Chọn một hoặc nhiều ảnh tải lên" };
        let plugin = this;
        plugin.settings = {};
        ...
        let createImg = function (src, id) {
            let $container = $("<div>", { class: "uploaded-image" }),
                ...
                $i = $("<i>", { class: "material-icons", text: "" }).appendTo($button);
            if (plugin.settings.preloaded.length) {
