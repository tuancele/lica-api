-- =====================================================
-- SQL Script: Reset Stock History và Inventory Stocks (SAFE VERSION)
-- Mục đích: Xóa sạch lịch sử kho và reset tất cả số lượng về 0
-- Phiên bản an toàn: Sử dụng transaction để có thể rollback nếu cần
-- =====================================================
...
-- Nếu kết quả đúng, chạy COMMIT để lưu thay đổi
-- Nếu có vấn đề, chạy ROLLBACK để hoàn tác
-- COMMIT;
-- ROLLBACK;
