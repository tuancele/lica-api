...
<div class="box">
    <div class="box-header with-border">
        <div class="row">
            <div class="col-md-9">
                <div class="row">
                    <form method="get" action="{{route('color')}}"> 
            ...
            <div class="col-md-3">
                ...
                <a class="button add btn btn-info pull-right" href="{{route('color.create')}}"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
            </div>
        </div>
    </div><!-- /.box-header -->
    <div class="box-body">
        <form id="tblForm" method="post" delete-url="{{route('color.delete')}}" action-url="{{route('color.action')}}" update-url="{{route('color.sort')}}">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><div style="width:20px;height: 20px;margin-right:10px;background: {{$value->color}};float:left;border:1px solid #eee"></div>{{$value->name}}</td>
                            ...
                            <td>
                                <select class="select_status form-control" data-id="{{$value->id}}" data-url="{{route('color.status')}}">
                            ...
                            <td>
                                <a class="btn btn-primary btn-xs" href="{{route('color.edit',['id' =>$value->id])}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
