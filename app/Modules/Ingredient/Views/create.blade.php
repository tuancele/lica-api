...
<section class="content">
    <form role="form" id="tblForm" method="post" ajax="{{route('ingredient.store')}}">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="ingredient_search" name="name" class="form-control" data-validation="required length" data-validation-error-msg="Không được bỏ trống" data-validation-length="max250" data-validation-error-msg-length="Không được vượt quá 250 ký tự!">
                                </div>
