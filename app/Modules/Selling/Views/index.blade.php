...
<div class="box">
    <div class="box-header with-border">
        <div class="row">
            <div class="col-md-9">
                <div class="row">
                    <form method="get" action="/admin/selling"> 
            ...
            <div class="col-md-3">
                <a class="button add btn btn-info pull-right" href="/admin/selling/create"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
            </div>
        </div>
    </div><!-- /.box-header -->
    <div class="box-body">
        <form id="tblForm" method="post" delete-url="/admin/selling/delete" action-url="/admin/selling/action">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><strong>{{$value->name}}</strong><p>{!!$value->content!!}</p></td>
                            <td>{{date('d/m/Y',strtotime($value->created_at))}}</td>
                            <td>@if(isset($value->user)){{$value->user->name}}@endif</td>
                            <td>
                                <select class="select_status form-control" data-id="{{$value->id}}" data-url="/admin/selling/status">
                            ...
                            <td>
                                <a class="btn btn-primary btn-xs" href="/admin/selling/edit/{{$value->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa</a>
