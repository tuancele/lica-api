                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-item">
                            ...
                            <input type="number" name="weight" class="shopee-input" value="0" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-item">
                            <label class="form-label">Chiều dài (cm)</label>
                            <input type="number" name="length" class="shopee-input" value="10" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-item">
                            <label class="form-label">Chiều rộng (cm)</label>
                            <input type="number" name="width" class="shopee-input" value="10" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-item">
                            <label class="form-label">Chiều cao (cm)</label>
                            <input type="number" name="height" class="shopee-input" value="10" min="0" step="0.01">
                        </div>
                    </div>
                </div>
            </div>
