        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        <td>
                            <label class="control-label">Nội dung xuất:</label>
                            <input type="text" name="subject" class="form-control" data-validation="required" data-validation-error-msg="Không được bỏ trống" >
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <h4>Sản phẩm xuất</h4>
                <table class="table table-bordered table-striped" id="listProduct" number="1">
                    <tr>
                    ...
                    <tr class="item_product item-1" item="1">
                        ...
                        <td>
                            <input type="number" name="price[]" class="form-control price" data-validation="required" data-validation-error-msg="Không được bỏ trống" >
                        </td>
                        <td>
