...
<div class="box">
    <div class="box-header with-border">
        <div class="row">
            <div class="col-md-10"> 
                <div class="row">  
                    <form method="get" action="/admin/import-goods"> 
            ...
            <div class="col-md-2">
                <a class="button add btn btn-info pull-right" href="/admin/import-goods/create" style="margin-right:5px;"><i class="fa fa-plus" aria-hidden="true"></i> Tạo đơn hàng mới</a>
            </div>
        </div>
    </div><!-- /.box-header -->
    <div class="box-body">
        <form id="tblForm" method="post" delete-url="/admin/import-goods/delete" action-url="/admin/import-goods/action">
                ...
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th width="10%">Nội dung nhập </th>  
                            <th width="10%">Ghi chú</th>       
                            <th width="10%">Ngày nhập</th>
                            <th width="10%">Người nhập</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-primary btn-xs" href="/admin/import-goods/edit/{{$value->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
