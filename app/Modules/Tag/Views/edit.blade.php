...
<section class="content">
    <form role="form" id="tblForm" method="post" ajax="/admin/tag/edit">
        @csrf
        <div class="row">
            <div class="col-lg-9">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="textarea" name="content" rows="8" >{{$detail->content}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-3">
                ...
                @include('Layout::image-r2',['image' => $detail->image,'number' => 1, 'folder' => 'tags'])
            </div>
            <!-- /.col-lg-12 -->
        </div>
