...
<section class="content">
    <form role="form" id="tblForm" method="post" ajax="/admin/tag/create">
        @csrf
        <div class="row">
            <div class="col-lg-9">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control text-input" id="textarea" name="content" rows="8" ></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="seo_description" rows="5" data-validation="length" data-validation-length="max300" data-validation-error-msg-length="Không được vượt quá 300 ký tự!"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3">
                ...
                @include('Layout::image-r2',['number' => 1, 'folder' => 'tags'])
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <div class="fix_action">
            <div class="form-group">
                    ...
                    <a href="/admin/tag" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i> Danh sách</a>
            </div>
        </div>
    </form>
</section>
