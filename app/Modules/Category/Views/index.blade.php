...
<div class="box">
    <div class="box-header with-border">
        <div class="row">
            ...
            <div class="col-md-4">
                <a class="button add btn btn-info pull-right" href="{{route('category.create')}}" style="margin-right:5px;"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
                <a class="button add btn btn-warning pull-right" href="{{route('category.sort')}}" style="margin-right:5px;"><i class="fa fa-arrows-v" aria-hidden="true"></i> Sắp xếp</a>
            </div>
        </div>
    </div><!-- /.box-header -->
    <div class="box-body">
        <form id="tblForm" method="post" delete-url="{{route('category.delete')}}" action-url="{{route('category.action')}}">
            <div class="PageContent">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        {!! listCategory($categories,0,'','category')!!}
                    </tbody>
                </table>
            </div>
        </form>
