...
@section('title','Sắp xếp chuyên mục bài viết')
@section('content')
@include('admin.layout.breadcrumb',[
    'title' => 'Sắp xếp chuyên mục bài viết',
])
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <a href="{{route('category')}}" class="btn btn-danger"><i class="fa fa-undo" aria-hidden="true"></i> Quay lại danh sách</a>
            </div>
        </div>
    </div>
</div>
