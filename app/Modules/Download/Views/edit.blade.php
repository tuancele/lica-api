...
<section class="content">
    <form role="form" id="tblForm" method="post" ajax="/admin/download/edit">
        @csrf
        <div class="row">
            <div class="col-lg-9">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control text-input" id="textarea" name="content" rows="8" >{{$detail->content}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-3">
                ...
                @include('Layout::image-r2',['image' => $detail->image,'number' => 1, 'folder' => 'downloads'])
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <div class="fix_action">
            <div class="form-group">
                ...
                <a href="/admin/download" class="btn btn-primary"><i class="fa fa-list" aria-hidden="true"></i> Danh sách</a>
            </div>
        </div>
    </form>
</section>
