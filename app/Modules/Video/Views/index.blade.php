...
<div class="box">
    <div class="box-header with-border">
        <div class="row">
            ...
            <div class="col-md-2">
                <a class="button add btn btn-info pull-right" href="/admin/video/create" style="margin-right:5px;"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
            </div>
        </div>
    </div><!-- /.box-header -->
    <div class="box-body">
        <form id="tblForm" method="post" delete-url="/admin/video/delete" action-url="/admin/video/action">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="select_status form-control" data-id="{{$post->id}}" data-url="/admin/video/status">
                            ...
                            <td>
                                <a class="btn btn-primary btn-xs" href="/admin/video/edit/{{$post->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa</a>
