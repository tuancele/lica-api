...
<div class="box">
    <div class="box-header with-border">
        <div class="row">
            ...
            <div class="col-md-4">
                <a class="button add btn btn-info pull-right" href="{{route('page.create')}}" style="margin-right:5px;"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
            </div>
        </div>
    </div><!-- /.box-header -->
    <div class="box-body">
        <form id="tblForm" method="post" delete-url="{{route('page.delete')}}" action-url="{{route('page.action')}}">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img class="img-responsive" src="{{getImage($value->image)}}"></td>
                            <td>
                                <a href="{{asset($value->slug)}}" target="_blank">{{$value->name}}</a>
                                <p>Lượt xem: {{$value->view}}</p>
                            </td>
                            ...
                            <td>
                                <select class="select_status form-control" data-id="{{$value->id}}" data-url="{{route('page.status')}}">
                            ...
                            <td>
                                <a class="btn btn-primary btn-xs" href="{{route('page.edit',['id' => $value->id])}}" style="margin-right:3px"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
