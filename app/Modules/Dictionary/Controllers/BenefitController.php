...
{
    private $model;
    private $controller = 'benefit';
    private $view = 'Dictionary';
    public function __construct(IngredientBenefit $model){
        $this->model = $model;
    }
    public function index(Request $request)
    {
        active('dictionary','benefit');
        ...
        return view($this->view.'::benefit.index',$data);
    }
    public function create(){
        active('dictionary','benefit');
        return view($this->view.'::benefit.create');
    }
    public function edit($id){
        active('dictionary','benefit');
        $detail = $this->model::find($id);
        if(!isset($detail) && empty($detail)){
            return redirect()->route('dictionary.benefit');
        }
        $data['detail'] = $detail;
        return view($this->view.'::benefit.edit',$data);
    }
    ...
    public function delete(Request $request)
    {
        ...
        if($request->page !=""){
            $url = route('dictionary.benefit').'?page='.$request->page;
        }else{
            $url = route('dictionary.benefit');
        }
        return response()->json([
