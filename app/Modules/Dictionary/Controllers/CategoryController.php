...
class CategoryController extends Controller
{
    ...
    public function __construct(IngredientCategory $model){
        $this->model = $model;
    }
    public function index(Request $request)
    {
        active('dictionary','category');
        ...
        return view($this->view.'::category.index',$data);
    }
    ...
    public function edit($id){
        ...
        $data['detail'] = $detail;
        return view($this->view.'::category.edit',$data);
    }
    ...
    public function delete(Request $request)
    {
        ...
        if($request->page !=""){
            $url = route('dictionary.category').'?page='.$request->page;
        }else{
            $url = route('dictionary.category');
        }
        return response()->json([
