...
@section('title','Thêm đánh giá thành phần')
@section('content')
@include('Layout::breadcrumb',[
    'title' => 'Thêm đánh giá thành phần',
])
<section class="content">
    <form role="form" id="tblForm" method="post" ajax="{{route('dictionary.rate.store')}}">
        @csrf
        <div class="row">
            <div class="col-lg-6">
        ...
        <div class="fix_action">
            @include('Layout::action',['link'=>route('dictionary.rate')])
        </div>
    </form>
</section>
@endsection