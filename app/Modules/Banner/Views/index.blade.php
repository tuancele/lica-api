...
<div class="box">
    <div class="box-header with-border">
        <div class="row">
            <div class="col-md-9">
                <div class="row">
                    <form method="get" action="/admin/banner"> 
                    ...
                    <div class="col-md-2 pr-0">
                        ...
                        <select class="form-control" name="cat_id">
                            <option value=""  @if($cat_id == "") selected="" @endif>---Nhóm---</option>
                            <option value="1" @if($cat_id == 1 && $cat_id != "") selected="" @endif>Banner trang chủ</option>
                            <option value="2" @if($cat_id == 0 && $cat_id != "") selected="" @endif>Banner sidebar</option>
                        </select>
                    </div>
                    <div class="col-md-2 pr-0">
            ...
            <div class="col-md-3">
                <a class="button add btn btn-info pull-right" href="/admin/banner/create"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
            </div>
        </div>
    </div><!-- /.box-header -->
    <div class="box-body">
        <form id="tblForm" method="post" delete-url="/admin/banner/delete" action-url="/admin/banner/action">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{getImage($value->image)}}" style="width: 100px"></td>
                            <td>{{$value->name}}</td>
                            <td>{{date('d/m/Y',strtotime($value->created_at))}}</td>
                            <td>@if(isset($value->user)){{$value->user->name}}@endif</td>
                            <td>
                                <select class="select_status form-control" data-id="{{$value->id}}" data-url="/admin/banner/status">
                            ...
                            <td>
                                <a class="btn btn-primary btn-xs" href="/admin/banner/edit/{{$value->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa</a>
