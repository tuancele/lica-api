...
@section('title','Từ khóa tìm nhiều')
@section('content')
@include('Layout::breadcrumb',[
    'title' => 'Từ khóa tìm nhiều',
])
    ...
    <div class="box-header with-border">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <a class="button add btn btn-info pull-right" href="{{route('search.create')}}"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
            </div>
        </div>
    </div><!-- /.box-header -->
    <div class="box-body">
        <form id="tblForm" method="post" delete-url="{{route('search.delete')}}" action-url="{{route('search.action')}}" update-url="{{route('search.sort')}}">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="select_status form-control" data-id="{{$value->id}}" data-url="{{route('search.status')}}">
                            ...
                            <td>
                                <a class="btn btn-primary btn-xs" href="{{route('search.edit',['id' =>$value->id])}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
