                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <select class="form-control" name="role_id">
                                ...
                                <option value="2" @if($detail->role_id == 2) selected="" @endif>Đăng bài</option>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <select class="form-control" name="status">
                                <option value="1" @if($detail->status == 1) selected="" @endif>Hoạt động</option>
                                <option value="0" @if($detail->status == 0) selected="" @endif>Ngừng hoạt động</option>
                            </select>
                        </div>
        ...
        rules: { 
            ...
            email:{
                ...
                remote: {
                    ...
                    data: {
                        email: function () {
                            return $('#formEditUser :input[name="email"]').val();
                        },
                        id: function () {
                            return $('#formEditUser :input[name="id"]').val();
                        },
                    }
                },
                email:true,   
