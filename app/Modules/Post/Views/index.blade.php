...
<div class="box">
    <div class="box-header with-border">
        <div class="row">
            <div class="col-md-10"> 
                <div class="row">  
                    ...
                    <div class="col-md-3 pr-0">
                        @php $catid = request()->get('cat_id') @endphp
                        <select class="form-control" name="cat_id">
                            <option value=""  @if($catid == "") selected="" @endif>---Chọn chuyên mục---</option>
            ...
            <div class="col-md-2">
                <a class="button add btn btn-info pull-right" href="{{route('post.create')}}" style="margin-right:5px;"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
            </div>
        </div>
    </div><!-- /.box-header -->
    <div class="box-body">
        <form id="tblForm" method="post" delete-url="{{route('post.delete')}}" action-url="{{route('post.action')}}">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="select_status form-control" data-id="{{$post->id}}" data-url="{{route('post.status')}}">
                            ...
                            <td>
                                <a class="btn btn-primary btn-xs" href="{{route('post.edit',['id' => $post->id])}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
