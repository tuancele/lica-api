...
<div class="modal-body">
    <div class="form-group" style="display: flex;">
        ...
        <button type="button" class="btn btn-primary btn_search2" style="border-radius: initial;">Tìm sản phẩm</button>
    </div>
  ...
  <script>
    ...
    $('.btn_search2').click(function(){
        var search = $('#myModal2 input[name="search"]').val();
        var brand = $('#myModal2 select[name="brand"]').val();
        $.ajax({
            type: 'post',
