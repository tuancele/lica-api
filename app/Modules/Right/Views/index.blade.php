...
@section('title','Danh sách quyền lợi khách hàng')
@section('content')
...
<div class="box">
    <div class="box-header with-border">
        <div class="row">
            <div class="col-md-9">
                <div class="row">
                    <form method="get" action="/admin/right"> 
            ...
            <div class="col-md-3">
                <a class="button add btn btn-info pull-right" href="/admin/right/create"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
            </div>
        </div>
    </div><!-- /.box-header -->
    <div class="box-body">
        <form id="tblForm" method="post" delete-url="/admin/right/delete" action-url="/admin/right/action">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="background:#333"><img src="{{getImage($value->image)}}" style="width: 100px"></td>
                            <td>{{$value->name}}<p><strong>{{$value->content}}</strong></p></td>
                            <td>{{date('d/m/Y',strtotime($value->created_at))}}</td>
                            <td>@if(isset($value->user)){{$value->user->name}}@endif</td>
                            <td>
                                <select class="select_status form-control" data-id="{{$value->id}}" data-url="/admin/right/status">
                            ...
                            <td>
                                <a class="btn btn-primary btn-xs" href="/admin/right/edit/{{$value->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa</a>
