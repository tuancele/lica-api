...
<div class="box">
    <div class="box-header with-border">
        <div class="row">
            <div class="col-md-9">
                <div class="row">
                    <form method="get" action="/admin/slider"> 
            ...
            <div class="col-md-3">
                <a class="button add btn btn-info pull-right" href="/admin/slider/create"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</a>
            </div>
        </div>
    </div><!-- /.box-header -->
    <div class="box-body">
        <form id="tblForm" method="post" delete-url="/admin/slider/delete" action-url="/admin/slider/action">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="select_status form-control" data-id="{{$value->id}}" data-url="/admin/slider/status">
                            ...
                            <td>
                                <a class="btn btn-primary btn-xs" href="/admin/slider/edit/{{$value->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa</a>
