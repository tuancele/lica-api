...
/**
 * Form Request for updating an export receipt
 * 
 * This class handles validation and authorization
 * for export receipt update requests.
 */
class UpdateExportReceiptRequest extends FormRequest
{
    /**
