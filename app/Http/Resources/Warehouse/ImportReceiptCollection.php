...
/**
 * Import Receipt Collection Resource
 * 
 * Formats collection of import receipts for API output
 */
class ImportReceiptCollection extends ResourceCollection
{
    /**
        ...
        return [
            'data' => $this->collection->map(function ($receipt) {
                ...
                return [
                    'id' => $receipt->id,
                    'code' => $receipt->code,
                    'receipt_code' => getImportReceiptCode($receipt->id, $receipt->created_at),
