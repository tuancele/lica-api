		...
		<div style="border:1px solid #d8dfe6;background-color:#ffffff;padding:20px 10px 30px 10px">
			...
			<div>
				...
				<div style="width:100%;overflow: hidden;font-size:13px">
					...
					<table style="border-collapse: collapse;border-spacing: 2px;border-color: grey;">
						<tr style="border: #C2C2C2 1px solid;">
							<td width="30%" style="border-right: #C2C2C2 1px solid;padding:10px">Họ tên</td>
							<td style="border-right: #C2C2C2 1px solid;padding:10px">{{$info['name']}}</td>
						</tr>
						<tr style="border: #C2C2C2 1px solid;">
							<td width="30%" style="border-right: #C2C2C2 1px solid;padding:10px">Số điện thoại</td>
							<td style="border-right: #C2C2C2 1px solid;padding:10px">{{$info['phone']}}</td>
						</tr>
						<tr style="border: #C2C2C2 1px solid;">
							<td width="30%" style="border-right: #C2C2C2 1px solid;padding:10px">Địa chỉ email</td>
							<td style="border-right: #C2C2C2 1px solid;padding:10px">{{$info['email']}}</td>
						</tr>
						<tr style="border: #C2C2C2 1px solid;">
							<td width="30%" style="border-right: #C2C2C2 1px solid;padding:10px">Nội dung</td>
							<td style="border-right: #C2C2C2 1px solid;padding:10px">{{$info['content']}}</td>
						</tr>
					</table>
				</div>
			</div>
