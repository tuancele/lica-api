				...
				<div style="width:100%;overflow: hidden;font-size:13px">
					...
					<table style="border-collapse: collapse;border-spacing: 2px;border-color: grey;">
						<tr style="border: #C2C2C2 1px solid;">
							<td width="30%" style="border-right: #C2C2C2 1px solid;padding:10px">Email đăng nhập</td>
							<td style="border-right: #C2C2C2 1px solid;padding:10px">{{$data['body']['email']}}</td>
						</tr>
						<tr style="border: #C2C2C2 1px solid;">
							<td width="30%" style="border-right: #C2C2C2 1px solid;padding:10px">Mật khẩu đăng nhập</td>
							<td style="border-right: #C2C2C2 1px solid;padding:10px">{{$data['body']['password']}}</td>
						</tr>
					</table>
				</div>
			</div>
